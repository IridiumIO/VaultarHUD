...
public class KeyBindings {
    ...
    public static final KeyMapping ENABLE_HUD = new KeyMapping(KEY_ENABLE, KeyConflictContext.UNIVERSAL, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_O, KEY_CATEGORY);
